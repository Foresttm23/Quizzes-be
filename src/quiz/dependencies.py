...
async def get_attempt_service(db: DBSessionDep, member_service: CompanyMemberServiceDep,
                              quiz_service: CompanyQuizServiceDep, ) -> AttemptService:
    return AttemptService(db=db, member_service=member_service, quiz_service=quiz_service)
