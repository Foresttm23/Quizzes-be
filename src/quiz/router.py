...
from .schemas import (
    ...
    SaveAnswerRequestSchema, QuizAttemptBaseSchema,
)
...
async def get_questions(
    ...
    questions = await quiz_service.get_questions_and_options(company_id=company_id, quiz_id=quiz_id, is_admin=is_admin)
    return questions
...
async def get_quiz_attempt(
    ...
    return await attempt_service.get_attempt_results(user_id=user.id, attempt_id=attempt_id, is_admin=False)
