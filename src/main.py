...
from src.company.router import requests_router, companies_router, invitations_router
from src.core.config import settings
from src.core.database import init_db
from src.core.logger import logger
from src.core.redis import redis_client, pool
from src.quiz.router import quiz_router, quiz_attempt_router
...
if __name__ == "__main__":
    uvicorn.run("src.main:src", host=settings.APP.HOST, port=settings.APP.PORT, reload=settings.APP.RELOAD, )
