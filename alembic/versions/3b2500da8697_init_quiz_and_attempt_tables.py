...
def upgrade() -> None:
    ...
    op.create_table('company_quizzes',
    ...
    op.create_table('quiz_attempts',
                    ...
                    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'),
                              nullable=False),
                    sa.ForeignKeyConstraint(['quiz_id'], ['company_quizzes.id'], ondelete='CASCADE'),
    ...
    op.create_table('quiz_attempt_answers',
                    ...
                    sa.ForeignKeyConstraint(['question_id'], ['quiz_questions.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['selected_option_id'], ['quiz_answer_options.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
