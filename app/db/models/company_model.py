...
from sqlalchemy import UUID, DateTime, String, Text, Boolean, ForeignKey, Table, Column
from sqlalchemy.orm import Mapped, mapped_column, relationship
from sqlalchemy.sql import func

from app.db.postgres import Base

# Association table for many-to-many relationship between users and companies (as admins)
...
class Company(Base):
    ...
    owner: Mapped["User"] = relationship("User", backref="owned_companies")
    ...
    admins: Mapped[list["User"]] = relationship("User", secondary=company_admins, backref="admin_companies",
                                                lazy="selectin")
