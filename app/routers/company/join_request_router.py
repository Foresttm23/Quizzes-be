...
from app.schemas.company.inv_req_schema import RequestDetailsResponse, AcceptRequestResponse
...
@router.get("/user/pending", response_model=PaginationResponse[RequestDetailsResponse],
            status_code=status.HTTP_200_OK, )
