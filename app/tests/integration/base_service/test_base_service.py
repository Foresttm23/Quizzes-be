...
async def test_fetch_instances_paginated(test_base_service: _TestService, page, page_size, expected_has_next,
                                         expected_has_prev):
...
async def test_update_instance_no_changes(test_base_service: _TestService, created_instance: UserModel):
...
async def test_delete_instance_success(test_base_service: _TestService, testdb_session: AsyncSession,
