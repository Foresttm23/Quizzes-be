...
from .test_base_service_setup import _TestService, _TestUserRepository, _TestCreateSchema
...
async def created_instance(test_base_service: _TestService) -> UserModel:
    instance_info = _TestCreateSchema(email="instance@example.com", username="instanceuser")
