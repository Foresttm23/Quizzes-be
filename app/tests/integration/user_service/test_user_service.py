...
async def test_update_user_info_username(
    ...
    updated_user = await test_user_service.update_user_info(
        user=created_user, new_user_info=new_user_info
    )
...
async def test_update_user_password_success(
    ...
    new_password_info = (
        UserPasswordUpdateRequest(  # Since created user saves hashed_password only
    ...
    updated_user = await test_user_service.update_user_password(
        user=created_user, new_password_info=new_password_info
    )
...
async def test_fetch_users_paginated(
    ...
    paginated_users = await test_user_service.get_users_paginated(
