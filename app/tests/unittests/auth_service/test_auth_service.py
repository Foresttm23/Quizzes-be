...
def test_verify_token_and_get_payload_auth0_fallback_success(auth_service, mock_auth_utils):
...
def test_create_access_token_calls_repo_correctly(mocker, auth_service, mock_user, mock_auth_utils):
    ...
    mock_auth_utils.create_access_token.assert_called_once_with(data=expected_data,
